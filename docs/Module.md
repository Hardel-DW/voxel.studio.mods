...
### Module Compose -> Gère tout le rendu.
...
Il faut travailler une sorte de React-Scan, un overlay qui affiche le FPS, et indique quels composant est re-rendu avec un encadrés, ont doit le faire le plus dynmaiquement et génériquement possible, une couche par dessus Compose uniquement.
...
C:\Users\Hardel\Desktop\repository\asset_editor\src\client\kotlin\fr\hardel\asset_editor\client\compose\lib\action\EnchantmentActions.kt. Ce fichier ne devrait pas exister. Les actions et interactions doivent être généralisées et optimistic de manière générale pas au cas par cas pour chaque action.

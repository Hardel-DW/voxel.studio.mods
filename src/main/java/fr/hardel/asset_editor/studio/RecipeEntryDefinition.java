...
public record RecipeEntryDefinition(
    ...
    ).apply(instance, (recipeTypes, special, templateKind, showAdvanced) ->
        new RecipeEntryDefinition(Identifier.fromNamespaceAndPath("minecraft", "unknown"), recipeTypes, special, templateKind, showAdvanced)
    ));

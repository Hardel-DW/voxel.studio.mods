...
public sealed interface ComponentWidget {

    Codec<ComponentWidget> CODEC = Codec.lazyInitialized(
        () -> Type.CODEC.dispatch("type", ComponentWidget::type, Type::codec));
    ...
    enum Type implements StringRepresentable {
        ...
        MapCodec<? extends ComponentWidget> codec() {
            return switch (this) {
                ...
                case TEXT_COMPONENT -> TextComponentWidget.MAP_CODEC;
    ...
    record IntegerWidget(Optional<Integer> min, Optional<Integer> max, Optional<Integer> defaultValue) implements ComponentWidget {
    ...
    record FloatWidget(Optional<Float> min, Optional<Float> max, Optional<Float> defaultValue) implements ComponentWidget {
    ...
    record BooleanWidget(Optional<Boolean> defaultValue) implements ComponentWidget {
    ...
    record UnitWidget() implements ComponentWidget {
    ...
    record StringWidget(Optional<Integer> maxLength, Optional<String> defaultValue) implements ComponentWidget {
    ...
    record IdentifierWidget(Optional<Identifier> defaultValue) implements ComponentWidget {
    ...
    record TextComponentWidget() implements ComponentWidget {
        public static final TextComponentWidget INSTANCE = new TextComponentWidget();
        public static final MapCodec<TextComponentWidget> MAP_CODEC = MapCodec.unit(INSTANCE);
    ...
    record EnumWidget(List<String> values, Optional<String> defaultValue) implements ComponentWidget {
    ...
    record HolderWidget(Identifier registry) implements ComponentWidget {
    ...
    record HolderSetWidget(Identifier registry) implements ComponentWidget {
    ...
    record TagWidget(Identifier registry) implements ComponentWidget {
    ...
    record Field(String key, ComponentWidget widget, boolean optional) {
        public static final Codec<Field> CODEC = RecordCodecBuilder.create(i -> i.group(
            Codec.STRING.fieldOf("key").forGetter(Field::key),
            ComponentWidget.CODEC.fieldOf("widget").forGetter(Field::widget),
            Codec.BOOL.optionalFieldOf("optional", false).forGetter(Field::optional)
        ).apply(i, Field::new));
    }

    record ObjectWidget(List<Field> fields) implements ComponentWidget {
    ...
    record ListWidget(ComponentWidget item, Optional<Integer> maxSize) implements ComponentWidget {
        public static final MapCodec<ListWidget> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
            ComponentWidget.CODEC.fieldOf("item").forGetter(ListWidget::item),
    ...
    record MapWidget(ComponentWidget key, ComponentWidget value) implements ComponentWidget {
        public static final MapCodec<MapWidget> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
            ComponentWidget.CODEC.fieldOf("key").forGetter(MapWidget::key),
            ComponentWidget.CODEC.fieldOf("value").forGetter(MapWidget::value)
    ...
    record DispatchedWidget(String discriminator, Map<String, ComponentWidget> cases) implements ComponentWidget {
        public static final MapCodec<DispatchedWidget> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
            ...
            Codec.unboundedMap(Codec.STRING, ComponentWidget.CODEC).fieldOf("cases").forGetter(DispatchedWidget::cases)
    ...
    record EitherWidget(ComponentWidget left, ComponentWidget right) implements ComponentWidget {
        public static final MapCodec<EitherWidget> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
            ComponentWidget.CODEC.fieldOf("left").forGetter(EitherWidget::left),
            ComponentWidget.CODEC.fieldOf("right").forGetter(EitherWidget::right)
    ...
    record RawJsonWidget() implements ComponentWidget {

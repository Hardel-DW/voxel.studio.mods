...
public record RemoveItemEverywhereAction(List<Identifier> items) implements EditorAction<Recipe<?>> {
    ...
    public static final StreamCodec<ByteBuf, RemoveItemEverywhereAction> CODEC = StreamCodec.composite(IDENTIFIER_LIST_CODEC, RemoveItemEverywhereAction::items, RemoveItemEverywhereAction::new);

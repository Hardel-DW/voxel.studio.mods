...
fun DebugWorkspacePage(context: StudioContext) {
    ...
    val sections = linkedMapOf<String, Any>(
        ...
        I18n.get("debug:workspace.section.navigation") to navigationSnapshot,
        I18n.get("debug:workspace.section.pack") to packSnapshot,
...
private data class DebugWorkspaceOverview(
...
private data class DebugWorkspaceRegistriesSnapshot(val counts: Map<String, Int>)

...
object EnchantmentTreeData {
    ...
    val ITEM_TAGS = listOf(
        ...
        ItemTagConfig(Identifier.fromNamespaceAndPath("minecraft", "enchantable/range")),
        ItemTagConfig(Identifier.fromNamespaceAndPath("minecraft", "enchantable/fishing")),
        ItemTagConfig(Identifier.fromNamespaceAndPath("minecraft", "enchantable/shield")),
        ItemTagConfig(Identifier.fromNamespaceAndPath("minecraft", "enchantable/weapon")),
        ItemTagConfig(Identifier.fromNamespaceAndPath("minecraft", "enchantable/melee")),
        ...
        ItemTagConfig(Identifier.fromNamespaceAndPath("minecraft", "enchantable/elytra")),
        ...
        ItemTagConfig(Identifier.fromNamespaceAndPath("minecraft", "enchantable/axes")),
        ItemTagConfig(Identifier.fromNamespaceAndPath("minecraft", "enchantable/shovels")),
        ItemTagConfig(Identifier.fromNamespaceAndPath("minecraft", "enchantable/hoes")),
        ItemTagConfig(Identifier.fromNamespaceAndPath("minecraft", "enchantable/pickaxes")),

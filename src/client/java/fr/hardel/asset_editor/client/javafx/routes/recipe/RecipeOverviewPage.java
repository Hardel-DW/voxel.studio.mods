...
public final class RecipeOverviewPage extends VBox {
    ...
    public RecipeOverviewPage(StudioContext context) {
        ...
        Label title = new Label(I18n.get("recipe:overview.no.recipes.found"));
        title.getStyleClass().add("concept-overview-empty-title");
        Label body = new Label(I18n.get("recipe:overview.try.adjusting.search.or.filter"));
